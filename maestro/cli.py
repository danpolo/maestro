...
# building this check, see `docs/plans/2026-08-30-pre-integration-c7-report.md`) print a
# client-side "I don't recognise this model" marker within a couple of seconds, *before*
